...
Usage:
    python sae/train_semantic.py \
        ...
        --layer 12 --save_dir out/dsi_sae_semantic
"""
...
def train(args):
    ...
    loader = CachedActivationLoader(args.cache_dir, args.layer)
    d_in = loader.d_in
    ...
    print(f"  EV={explained_variance:.4f}  L0={l0:.1f}  "
    ...
    # Training weights (with topk_threshold + scaling_factor)
    save_file({
